...
var localization = {
    en: {
        ...
        <code> 
         ...
         geom_bar( position ="stack",alpha=0.4) +
        ...
        ggplot(data=Dataset2,aes(x ='',y=weight,fill=origin)) +
         geom_bar( position ="stack",alpha=0.4,stat="identity") +
    ...
    constructor() {
        ...
        var objects = {
            ...
            dropna: {
                ...
                optionsLabels: { el: new labelVar(config, { no: 'optionsLabels', style: "mt-2",label: localization.en.optionsLabels, h: 5 }) },
